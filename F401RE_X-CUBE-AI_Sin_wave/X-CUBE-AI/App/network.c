...
#define AI_NETWORK_MODEL_SIGNATURE     "0x3a06010fc733ec8dfb99c8612371e567"
...
#define AI_TOOLS_DATE_TIME   "2025-09-26T17:19:02+0900"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    128, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_dense_16_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &gemm_2_output),
  &gemm_0_layer, 0xbeffcf71, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_dense_16_input0_output_array.data = AI_PTR(g_network_activations_map[0] + 60);
    serving_default_dense_16_input0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 60);
